...
X(GPIOA,  6, BUFFER_DIR  , ALTERNATE  , LOW , PUSHPULL ,  LOW , PULLDOWN , 13) \
...
X(GPIOB,  4, SPI1_MISO   , ALTERNATE  , LOW , PUSHPULL , HIGH , FLOATING ,  5) \
...
X(GPIOB,  8, PB8         , ALTERNATE  , LOW , PUSHPULL , HIGH , PULLUP   , 13) \
X(GPIOB,  9, PB9         , ALTERNATE  , LOW , PUSHPULL , HIGH , PULLUP   , 13) \
...
X(GPIOC, 11, QSPI_CS     , ALTERNATE  , LOW , PUSHPULL ,  LOW , PULLUP   ,  9) \
...
X(GPIOF, 14, I2C4_SCL    , ALTERNATE  , LOW , OPENDRAIN,  LOW , FLOATING ,  4) \
X(GPIOF, 15, I2C4_SDA    , ALTERNATE  , LOW , OPENDRAIN,  LOW , FLOATING ,  4) \
...
X(GPIOG,  6, DCMI_D12    , ALTERNATE  , LOW , PUSHPULL , HIGH , PULLUP   , 13) \
X(GPIOG,  7, DCMI_D13    , ALTERNATE  , LOW , PUSHPULL , HIGH , PULLUP   , 13) \
X(GPIOG,  8, PG8         , INPUT      , LOW , PUSHPULL ,  LOW , PULLUP   ,  0) \
X(GPIOG,  9, DCMI_VSYNC  , ALTERNATE  , LOW , PUSHPULL ,  LOW , PULLDOWN , 13) \
X(GPIOG, 10, PG10        , INPUT      , LOW , PUSHPULL ,  LOW , PULLUP   ,  0) \
X(GPIOG, 11, SPI1_CLK    , ALTERNATE  , LOW , PUSHPULL ,  LOW , PULLUP   ,  5) \
X(GPIOG, 12, PG12        , INPUT      , LOW , PUSHPULL ,  LOW , PULLUP   ,  0) \
X(GPIOG, 13, PG13        , INPUT      , LOW , PUSHPULL ,  LOW , PULLUP   ,  0) \
X(GPIOG, 14, PG14        , INPUT      , LOW , PUSHPULL ,  LOW , PULLUP   ,  0) \
...
X(GPIOH,  8, DCMI_HSYNC  , INPUT      , LOW , PUSHPULL , HIGH , PULLDOWN ,  0) \
